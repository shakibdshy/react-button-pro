...
const spinner = cva(
  "inline-block animate-spin rounded-full align-middle",
  {
    variants: {
      color: {
...
export default function Spinner(props: SpinnerProps) {
  ...
  return (
    ...
    >
      {custom}
      {!custom && (
        <div className={cn(spinner({ color, variant: props.variant, size: props.size }), className)} role="status">
